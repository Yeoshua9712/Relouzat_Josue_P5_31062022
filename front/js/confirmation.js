...
function getOrderId() {  
    // Créer la fonction getOrderId qui récupère l'id de la commande et l'assigne à une variable orderId  
    ...
    return searchParams.get("orderId") // Récupérer l'id dans l'url et l'assigner à la variable orderId

};

function displayOrderId(orderId) { // Créer la fonction displayOrderId qui affiche l'id de la commande dans le DOM  et qui prend en paramètre l'id de la commande orderId
